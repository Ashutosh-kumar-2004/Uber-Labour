...
import { badgeCls, btnCls, alertCls, OVERLAY } from "./adminUtils";
...
const ForceAssignModal = ({ task, onClose, onAssigned }) => {
  ...
  const handleAssign = async () => {
    ...
    try {
      ...
      setAlert({ msg: "Task assigned successfully!", type: "success" });
      setTimeout(() => onAssigned(), 1000);
    } catch {
      setAlert({ msg: "Failed to assign task", type: "error" });
    } finally {
      setAssigning(false);
    }
  };
